...
pub mod ffi {
    ...
    fn FillInterleavedOutputBufferF32(self: Pin<&mut ResonanceAudioApi>, num_channels: usize, num_frames: usize, buffer: &mut [f32]) -> bool;
    ...
    fn CreateSoundObjectSource(self: Pin<&mut ResonanceAudioApi>, rendering_mode: RenderingMode) -> i32;

    #[rust_name = "destroy_source"]
    fn DestroySource(self: Pin<&mut ResonanceAudioApi>, id: i32);

    #[rust_name = "set_interleaved_buffer_f32"]
    fn SetInterleavedBufferF32(self: Pin<&mut ResonanceAudioApi>, source_id: i32, audio: &[f32], num_channels: usize, num_frames: usize);
    ...
    fn SetSourceDistanceModel(self: Pin<&mut ResonanceAudioApi>, source_id: i32, rolloff: DistanceRolloffModel, min_distance: f32, max_distance: f32);
    ...
    fn SetSourceRoomEffectsGain(self: Pin<&mut ResonanceAudioApi>, source_id: i32, room_effects_gain: f32);

    #[rust_name = "set_source_rotation"]
    fn SetSourceRotation(self: Pin<&mut ResonanceAudioApi>, source_id: i32, x: f32, y: f32, z: f32, w: f32);
    ...
    fn SetSoundObjectDirectivity(self: Pin<&mut ResonanceAudioApi>, source_id: i32, alpha: f32, order: f32);

    #[rust_name = "set_sound_object_listener_directivity"]
    fn SetSoundObjectListenerDirectivity(self: Pin<&mut ResonanceAudioApi>, source_id: i32, alpha: f32, order: f32);

    #[rust_name = "set_sound_object_near_field_effect_gain"]
    fn SetSoundObjectNearFieldEffectGain(self: Pin<&mut ResonanceAudioApi>, source_id: i32, gain: f32);

    #[rust_name = "set_sound_object_occlusion_intensity"]
    fn SetSoundObjectOcclusionIntensity(self: Pin<&mut ResonanceAudioApi>, source_id: i32, intensity: f32);
